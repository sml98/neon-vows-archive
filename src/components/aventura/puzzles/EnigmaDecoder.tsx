  ...
  return (
    <div className="flex flex-col items-center w-full max-w-md mx-auto space-y-6">
      <CyberTextBox>
        ...
        <p className="text-[var(--neon-cyan)] text-sm mb-4 text-center">NÍVEL: SECRETO</p>
        ...
        <div className="flex justify-center space-x-4 mb-6 font-display text-2xl">
          <span
            className={
              step > 0 || completed
                ? "text-[var(--neon-pink)] drop-shadow-[0_0_8px_var(--neon-pink)]"
                : "text-gray-500"
            }
          >
            {getWordDisplay(0)}
        ...
        {!completed && (
          <div className="flex flex-col space-y-4">
            <p className="text-[var(--neon-cyan)] text-center">&gt; {RIDDLES[step].question}</p>
